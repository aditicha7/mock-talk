...
llm = OpenAI(temperature = 0.9, model = "gpt-3.5-turbo-0613")
...
chain.run(
    text = print("Welcome to MockTalk.ai! We're here to help you prepare for any upcoming interviews that you may have. \nTo start off:\n"),
    deadline = input("When is the date of your interview (MM/DD/YYYY)? "),
...
# agent.run(
#     print("Provide either a interview question based on difficulty or a leetcode prompt based on difficulty and . You are an interviewing me who wants to work at {company} as a {difficulty} {role}. Do not include both at the same time.")
# )
